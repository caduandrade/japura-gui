...
public class Calendar extends JComponent{
  ...
  public void update() {
	...
	getNextMonthButton().setDisabledForeground(
		pp.getDisabledForeground(getNextMonthButton()));
	getNextYearButton().setDisabledForeground(
		pp.getDisabledForeground(getNextYearButton()));
	...
	getNextMonthButton().setMouseOverForeground(
		pp.getMouseOverForeground(getNextMonthButton()));
	getNextYearButton().setMouseOverForeground(
		pp.getMouseOverForeground(getNextYearButton()));
